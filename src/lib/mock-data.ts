...
export const journalEntries: JournalEntry[] = [
  // 2026
  { _id: "j30", title: "Winter Stillness", slug: "winter-stillness", publishedAt: "2026-02-10T10:00:00Z", excerpt: "Silence between snowfalls, captured in monochrome.", body: "The first snow arrived without announcement — a thin veil over the rooftops that softened every edge the city had spent decades sharpening. I stood at the studio window with a cold cup of tea, watching the street below dissolve into a monochrome study.\n\nThere is a particular quality to winter light that I keep returning to. It strips away distraction, leaving only form and shadow. The bare branches outside became calligraphic marks against a pale sky, each one deliberate, each one patient.\n\nI spent the morning printing a series I had been sitting with since November — images of empty corridors and stairwells in a brutalist housing block on the outskirts of the city. In the quiet of the darkroom the grain emerged slowly, each frame holding its breath before revealing itself.\n\nWinter demands a slower practice. The cold shortens the days but lengthens the looking. I find myself noticing things I would walk past in summer: the texture of frozen condensation on a shop window, the geometry of tyre tracks in fresh snow, the way lamplight pools on wet pavement after dark. These are not dramatic subjects, but they are honest ones.", coverImage: "https://images.unsplash.com/photo-1491002052546-bf38f186af56?w=800&q=80" },
  { _id: "j31", title: "The Quiet Studio", slug: "the-quiet-studio", publishedAt: "2026-02-06T10:00:00Z", excerpt: "Morning rituals and the warmth of familiar tools.", body: "The studio is best before nine. The radiator ticks as it warms, the kettle hums, and the city outside is still deciding whether to wake up. I have come to treasure this hour more than any other — it belongs entirely to the work.\n\nThis morning I laid out contact sheets from a recent walk along the canal. The images are quiet, almost hesitant: reflections broken by passing barges, a heron standing impossibly still against industrial backdrops. There is a tension in them that I want to explore further.\n\nThe tools in this room have their own histories. The enlarger belonged to a photographer I admired in my twenties. The paper cutter has a nick in the blade from a careless afternoon years ago. These imperfections are comforting — they remind me that the work is cumulative, built day by day.", coverImage: "https://images.unsplash.com/photo-1513364776144-60967b0f800f?w=800&q=80" },
  { _id: "j32", title: "Portraits in February", slug: "portraits-february", publishedAt: "2026-02-03T10:00:00Z", excerpt: "Faces and stories through a winter lens.", body: "Full portable text body placeholder.", coverImage: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=800&q=80" },
  { _id: "j33", title: "Urban Geometry", slug: "urban-geometry", publishedAt: "2026-02-01T10:00:00Z", excerpt: "Lines, angles, and shadows in the city.", body: "Full portable text body placeholder.", coverImage: "https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=800&q=80" },
